...
<?php $component->withAttributes([]); ?>
        <div class="flex items-center gap-x-3">
            <!-- Display the user's profile picture or default avatar -->
            <!--[if BLOCK]><![endif]--><?php if($profilePictureUrl): ?>
...
<?php endif; ?>
            ...
            <form action="<?php echo e(filament()->getLogoutUrl()); ?>" method="post" class="my-auto">
                <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\Users\rijsewijk.r\Herd\laravelfilamentding\vendor\filament\filament\src\/../resources/views/widgets/account-widget.blade.php ENDPATH**/ ?>